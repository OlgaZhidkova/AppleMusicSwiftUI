...
var selectedMusic = [
    [
        LargePictureModel(type: "Избранная музыка", name: "Поп-музыка", description: "Станция AppleMusic", image: "bigradio2"),
        LargePictureModel(type: "Избранная музыка", name: "Танцевальная музыка", description: "Станция AppleMusic", image: "bigradio3")
    ],
    
    [
        LargePictureModel(type: "Избранная музыка", name: "Хиты", description: "Станция AppleMusic", image: "bigradio4"),
        LargePictureModel(type: "Избранная музыка", name: "Хип-хоп", description: "Станция AppleMusic", image: "bigradio5")
    ],
    
    [
        LargePictureModel(type: "Избранная музыка", name: "Чилаут", description: "Станция AppleMusic", image: "bigradio1"),
        LargePictureModel(type: "Избранная музыка", name: "Поп-музыка", description: "Станция AppleMusic", image: "bigradio2")
    ],
